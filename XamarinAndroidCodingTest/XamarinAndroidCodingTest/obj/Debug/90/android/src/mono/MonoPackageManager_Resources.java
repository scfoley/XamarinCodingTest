...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinAndroidCodingTest.dll" comes first in this list. */
		"XamarinAndroidCodingTest.dll",
		"SQLite-net.dll",
		...
		"XamarinAndroidCodingTest.Entity.dll",
		"XamarinAndroidCodingTest.Helpers.dll",
		"XamarinAndroidCodingTest.LocalStorage.dll",
	};
